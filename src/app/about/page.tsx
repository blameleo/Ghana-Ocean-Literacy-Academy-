...
function page() {
  ...
  return (
    <div className=" bg-slate-950 h-screen">
      ...
      <TracingBeam className="px-6 block sm:hidden h-screen bg-slate-950">
        <div className="max-w-2xl mx-auto antialiased pt-4 relative  bg-slate-950">
          {dummyContent.map((item, index) => (
            <div key={`content-${index}`} className="mb-10 bg-slate-950">
              {item.badge && (
